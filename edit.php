      ...
      <div class="insertForm">
         ...
         <div>
            <form name="insertForm" method="post" action="">
               ...
               <p><input type="text" name="club" placeholder="Enter Club" 
                  required value="<?php echo $row['club'];?>" /></p>
               <p><input type="text" name="dateofconcussion" id='datepicker' placeholder="Enter Date of Concussion" 
                  required value="<?php echo $row['dateofconcussion'];?>" /></p>
               <p><input type="text" name="refereename" placeholder="Enter Name of Referee" 
